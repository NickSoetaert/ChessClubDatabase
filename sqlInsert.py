...
'''
This is a highly hacky script that converts Chess.com PGN into SQL insert statements for my database.

A file that originally looks like this...
---
[Event "Live Chess"]
[Site "Chess.com"]
[Date "2018.12.01"]
...
---
will be transformend into a bunch of statements that look like this:
---
insert into Move
values
('00000', 1, 'e4', 'e5');
---
...with an insert statement for each move.
